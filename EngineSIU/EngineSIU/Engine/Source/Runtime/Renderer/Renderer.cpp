...
void FRenderer::CreateConstantBuffers()
{
    ...
    UINT CameraEffectConstantsBufferSize = sizeof(FCameraEffectConstants);
    BufferManager->CreateBufferGeneric<FCameraEffectConstants>("FCameraEffectConstants", nullptr, CameraEffectConstantsBufferSize, D3D11_BIND_CONSTANT_BUFFER, D3D11_USAGE_DYNAMIC, D3D11_CPU_ACCESS_WRITE);
